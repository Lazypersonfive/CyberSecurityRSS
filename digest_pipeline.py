...
评分标准：
- 9-10: 最新热门 CVE / 0day / 在野利用，且能说明漏洞原理、触发条件、影响版本、利用方式或修复缓解；国内官方预警、厂商 CERT/实验室首发、CTF/攻防竞赛高质量技术复盘
...
来源偏好：官方博客、研究团队、中文一线安全源和厂商安全团队优先于聚合转述；Google News 只做补充。
评分只看技术价值，不因语言、来源篇幅长短打折扣。
只返回 JSON 数组，形如 [{"idx":0,"score":8}]。""",
    "ai": """你是 AI 产业观察者，对 AI 动态资讯做 0-10 打分。目标是每日 15 条 AI 动态；候选足够时，至少 3 条中文来源。
编辑目标：覆盖主流实验室、模型发布、Agent 能力、重要产品、开源项目、算力/生态/监管变化；避免让 Google News 聚合稿盖掉官方博客、论文/项目页或中文一线媒体首发。
评分标准：
...
来源偏好：官方博客、论文/项目页、开发者公告、中文一线媒体或官方源首发，优先于 Google News 聚合转述。
...
5. 如果原文来自 Google News 或其他聚合源，摘要不得写成“某媒体报道”，应回到事件主体；但不得编造原文没有的来源细节。
...
8. 如果原文来自 Google News 或其他聚合源，摘要不得写成“某媒体报道”，应回到漏洞、工具、通告或事件主体；但不得编造原文没有的技术细节。
