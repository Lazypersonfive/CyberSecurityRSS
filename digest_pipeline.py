...
来源偏好：官方博客、研究团队、中文一线安全源和厂商安全团队优先于聚合转述；Google News 和 X/RSSHub 信号只做补充。
评分只看技术价值，不因语言、来源篇幅长短打折扣。
只返回 JSON 数组，形如 [{"idx":0,"score":8}]。""",
...
来源偏好：官方博客、论文/项目页、开发者公告、中文一线媒体或官方源首发，优先于 Google News 聚合转述和 X/RSSHub 信号；X 动态只作为早期热点线索。
...
5. 如果原文来自 Google News、RSSHub/X 或其他聚合源，摘要不得写成“某媒体报道/某推文称”，应回到事件主体；但不得编造原文没有的来源细节。
...
8. 如果原文来自 Google News、RSSHub/X 或其他聚合源，摘要不得写成“某媒体报道/某推文称”，应回到漏洞、工具、通告或事件主体；但不得编造原文没有的技术细节。
