...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ai | 103 | 20 | 23 | 60 | 0 | 3 | 20 | 44 | 17 |
| ai_security | 63 | 15 | 3 | 45 | 0 | 4 | 15 | 13 | 11 |
| finance | 70 | 2 | 0 | 67 | 1 | 12 | 2 | 0 | 0 |
| security | 105 | 18 | 0 | 65 | 22 | 0 | 18 | 2 | 39 |

## Unknown Selected Sources

| Source | Count | Boards | Latest Example |
|---|---:|---|---|
| `0.0.0.0:8080` | 6 | security | [Google Vertex AI SDK 存在 Pickle 注入漏洞允许攻击者劫持模型上传并执行代码](http://0.0.0.0:8080/post/64351) |
...
| `cyberkendra.com` | 3 | security | [研究员发布 Windows Defender 提权 0-day 漏洞 RoguePlanet 及其 PoC](https://www.cyberkendra.com/2026/06/microsoft-defender-zero-day-poc-gives.html) |
