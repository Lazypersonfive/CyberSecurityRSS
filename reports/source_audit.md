...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ai | 105 | 21 | 16 | 68 | 0 | 4 | 21 | 39 | 19 |
| ai_security | 62 | 9 | 4 | 49 | 0 | 4 | 9 | 11 | 17 |
| finance | 70 | 2 | 0 | 67 | 1 | 10 | 2 | 0 | 0 |
| security | 105 | 15 | 0 | 70 | 20 | 0 | 15 | 0 | 41 |

## Unknown Selected Sources

| Source | Count | Boards | Latest Example |
|---|---:|---|---|
| `0.0.0.0:8080` | 8 | security | [CISA 警告 Joomla JCE 扩展存在满分漏洞 CVE-2026-48907，已被用于执行 PHP 代码](http://0.0.0.0:8080/post/64361) |
...
| `securityweek.com` | 1 | security | [Ivanti Sentry 关键 OS 命令注入漏洞遭到在野利用，蜜罐捕获到针对该漏洞的攻击尝试](https://www.securityweek.com/ivanti-sentry-exploitation-attempts-hitting-honeypots/) |
